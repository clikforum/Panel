...
def hw_panel_callback(command, param1=None):
    ...
    if command == HWPANEL_REGISTER:
        ...
        print("1 - Comando Start/Stop ricevuto")
        start_scan()  # Esegui la funzione start_scan() da hw_panel
        print("2 - Comando Start/Stop ricevuto")
        hwpanel.send_panel_state(2)  # Invia il comando Start/Stop al hw_panel
        print("3 - Comando Start/Stop ricevuto")
